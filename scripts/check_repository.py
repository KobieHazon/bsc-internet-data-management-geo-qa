...
required_files = ['assignment/HW_qa.pdf', 'assignment/HW_qa_tests.pdf', 'src/geo_qa.py', 'src/geo_queries.py', 'data/ontology.nt']
...
required_markers = ['rdflib', 'country', 'prime_minister', 'data/ontology.nt']
